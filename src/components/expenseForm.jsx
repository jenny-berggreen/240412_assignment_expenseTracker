  ...
  return (
    ...
    <form className={`${formStyles.expense_form} ${styles.flex}`}>
      <fieldset className={`${formStyles.expense_form_container} ${styles.flex} ${styles.flex_column}`}>
        ...
        <section className={`${styles.flex} ${styles.flex_row}`}>
          <div className={`${formStyles.input_group} ${styles.flex} ${styles.flex_column}`}>
          ...
          <div className={`${formStyles.input_group} ${styles.flex} ${styles.flex_column}`}>
            <label htmlFor="amount">Amount<sup>*</sup></label>
						<input type="text" name='amount' placeholder='Ex. 3.50' className={`${formStyles.input_element} ${formStyles.input_element__amount}`} />
						<p>Error</p>
          </div>
        </section>
